...
public class loginAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(250, 216, 89));
        ...
        jLabel10.setText("LOGIN RENTAL MOBIL");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       String pass="kapanyahkaya12";
       if(String.valueOf(passwordField.getPassword()).equals(pass)){
           Admin min;
           min=new Admin();
           min.setVisible(true);
           this.dispose();
